...
public class PdfGeneratorService {
    ...
    public byte[] generatePedidoPDF(PedidoDTO pedido, String tipoDocumento) {
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            String ruc = pedido.getUsuario() != null ? pedido.getUsuario().getRuc() : "N/A";
            String nombre = pedido.getUsuario() != null ? pedido.getUsuario().getNombre() : "N/A";
            String direccion = pedido.getUsuario() != null ? pedido.getUsuario().getDireccion() : "N/A";
    ...
    public byte[] generateClientesReport(List<PedidoDTO> pedidos) {
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            for (Map.Entry<Long, List<PedidoDTO>> entry : pedidosPorCliente.entrySet()) {
                ...
                table.addCell(new Cell().add(new Paragraph(
                    primerPedido.getUsuario().getNombre() + " " + primerPedido.getUsuario().getApellidos()
                )));
