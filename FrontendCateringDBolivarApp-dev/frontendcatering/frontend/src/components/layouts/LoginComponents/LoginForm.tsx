  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8080/api/auth/login", // Adjust the URL if your backend is on a different port/host
        { email, password }
      );
      ...
      router.push("/dashboard"); // Make sure you have a /pages/dashboard.tsx route
    } catch (err: any) {
