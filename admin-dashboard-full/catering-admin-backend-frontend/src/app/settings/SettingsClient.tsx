...
const SettingsClient = () => {
  const { fullName, email, username, phoneNumber, bio, setUserData } = useUser();
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="emailAddress"
                        id="emailAddress"
                        placeholder="Example.01@gmail.com"
                        defaultValue={email}
