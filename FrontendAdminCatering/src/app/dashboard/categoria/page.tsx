...
=======
  const [form, setForm] = useState<Partial<Categoria>>({ nombre: "", descripcion: "", activo: true });
  const [editId, setEditId] = useState<number | null>(null);
...
<<<<<<< HEAD
        ...
        type: "success",
=======
        message: editId ? "✅ Categoría actualizada con éxito" : "✅ Categoría creada con éxito", 
        type: 'success'
>>>>>>> origin/auth
      });
...
=======
          ...
          <Link href="/" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200">
>>>>>>> origin/auth
            Volver al inicio
          </Link>
        </div>
...
=======
            <h1 className="text-3xl font-bold text-gray-800 dark:text-slate-400">Gestión de Categorías</h1>
            <p className="text-gray-600 dark:text-slate-400">Administra las categorías de tu aplicación</p>
>>>>>>> origin/auth
          </div>
...
=======
              ...
              <span className="text-sm text-gray-500">
                {filteredCategorias.length} {filteredCategorias.length === 1 ? 'categoría' : 'categorías'}
              </span>
            </div>
...
<<<<<<< HEAD
                      ...
                      >
=======
                      <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:bg-slate-900">
                        Nombre
                      </th>
...
=======
                        <tr key={cat.id} className="hover:bg-gray-50 transition dark:bg-slate-950">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="font-medium text-gray-900">{cat.nombre}</div>
                            <div className="text-sm text-gray-500">ID: {cat.id}</div>
                          </td>
                          <td className="px-6 py-4">
                            <div className="text-sm text-gray-700 max-w-xs truncate">{cat.descripcion || '-'}</div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
